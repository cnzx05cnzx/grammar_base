...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_set',
                        help='Path to the train data', default='data/gec/train_pure.txt')
    parser.add_argument('--dev_set',
                        help='Path to the dev data', default='data/gec/dev.txt')
    ...
    #     for j in np.linspace(0.0, 1.0, 10):
    #         # args.
    main(args)

    # 280560it [01:12, 3863.13it/s] original
    # 280560it [08:23, 580.13it/s] with pinyin
